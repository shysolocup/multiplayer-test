...
# Singleton3D<T\>
##### Inherits from <code><a href="https://docs.godotengine.org/en/stable/classes/class_node3d.html">Node3D</a></code>, <code><a href="../IBaseSingleton">IBaseSingleton</a></code>
...
<code>T</code> is the instance you're creating so for example [`Workspace`](./Workspace.md) extends from `Singleton3D<Workspace>`.
